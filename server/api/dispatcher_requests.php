...
$table_name = 'dispatcher_requests';
...
function validateRequestData($dbManager, $data, $excludeId = null)
{
    $errors = [];
    global $table_name;
    ...
    case 'POST':
        switch ($method) {
            case 'insert':
                ...
                $validationResult = validateRequestData($dbManager, $dataToInsert, $table_name);
